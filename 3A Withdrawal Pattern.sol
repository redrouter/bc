...
// Event triggered whentokens are transferred.
...
// Fire the event "Approval"to execute any logic thatwas listening to it
...
/* ThetransferFrom method is used for a withdraw workflow, allowing contracts to send tokens on
your behalf, for example to "deposit" to a contract address and/or to charge fees in sub-currencies;*/
